...
_DEFAULT_RUNTIME_SYSTEM_MESSAGE: ChatMessage = {
    ...
    "content": (
        ...
        "would materially improve the answer. Stored memory keeps its original language "
        "and is matched lexically, so pass memory_recall keywords in both Chinese and "
        "English for key concepts.\n"
